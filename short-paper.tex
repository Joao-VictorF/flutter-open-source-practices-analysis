...
O dataset completo criado a partir desta pesquisa, contendo todas as VBPs e outras informações úteis sobre os projetos, está disponível em: \url{https://anonymous.4open.science/r/flutter-open-source-practices-analysis-F1F7/json-files/fetched_issues_data.json}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{images/correlação_entre_vbps_e_lcnc.png}
\includegraphics[width=0.45\textwidth]{images/correlação_entre_vbps_e_complexidade_ciclomática.png}
